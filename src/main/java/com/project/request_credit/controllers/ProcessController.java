...
public class ProcessController {
    ...
    public ResponseEntity<?> startProcess(@RequestBody User user) {
        ...
        Map<String, HashMap<String, HashMap<String, Object>>> variables = CreateJsonDeuxArgs("nom", user.getLastName(),
    ...
    public ResponseEntity<?> completeTaskOTP(@RequestBody User user, @RequestParam(required = true) String taskId) {
        ...
        Map<String, HashMap<String, HashMap<String, Object>>> variables = CreateJsonDeuxArgs("otp", user.getOtp() + "",
